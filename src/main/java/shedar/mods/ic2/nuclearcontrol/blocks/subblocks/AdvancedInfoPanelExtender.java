...
public class AdvancedInfoPanelExtender extends InfoPanel {
	private static final int DAMAGE = BlockDamages.DAMAGE_ADVANCED_EXTENDER;
	private static final float[] BOUNDS = { 0, 0, 0, 1, 1, 1 };

	private static final byte[][] mapping = {
			{ I_EXTENDER_ADV_SIDE, I_COLOR_DEFAULT, I_EXTENDER_ADV_SIDE,
					I_EXTENDER_ADV_SIDE, I_EXTENDER_ADV_SIDE,
					I_EXTENDER_ADV_SIDE },
			{ I_COLOR_DEFAULT, I_EXTENDER_ADV_SIDE, I_EXTENDER_ADV_SIDE,
					I_EXTENDER_ADV_SIDE, I_EXTENDER_ADV_SIDE,
					I_EXTENDER_ADV_SIDE },
			{ I_EXTENDER_ADV_SIDE, I_EXTENDER_ADV_SIDE, I_EXTENDER_ADV_SIDE,
					I_COLOR_DEFAULT, I_EXTENDER_ADV_SIDE, I_EXTENDER_ADV_SIDE },
			{ I_EXTENDER_ADV_SIDE, I_EXTENDER_ADV_SIDE, I_COLOR_DEFAULT,
					I_EXTENDER_ADV_SIDE, I_EXTENDER_ADV_SIDE,
					I_EXTENDER_ADV_SIDE },
			{ I_EXTENDER_ADV_SIDE, I_EXTENDER_ADV_SIDE, I_EXTENDER_ADV_SIDE,
					I_EXTENDER_ADV_SIDE, I_EXTENDER_ADV_SIDE, I_COLOR_DEFAULT },
	...
	public float[] getBlockBounds(TileEntity tileEntity) {
		...
		if (tileEntity != null) {
			...
			if (screen != null
					&& screen.getCore(tileEntity.getWorldObj()) instanceof TileEntityAdvancedInfoPanel) {
