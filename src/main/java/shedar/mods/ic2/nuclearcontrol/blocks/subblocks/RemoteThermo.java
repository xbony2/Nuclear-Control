...
public class RemoteThermo extends Subblock {
	private static final int DAMAGE = BlockDamages.DAMAGE_REMOTE_THERMO;
	...
	public Container getServerGuiElement(TileEntity tileEntity,
			EntityPlayer player) {
		return new ContainerRemoteThermo(player,
				(TileEntityRemoteThermo) tileEntity);
	}

	@Override
	public Object getClientGuiElement(TileEntity tileEntity, EntityPlayer player) {
		ContainerRemoteThermo container = new ContainerRemoteThermo(player,
				(TileEntityRemoteThermo) tileEntity);
	...
	public void registerIcons(IIconRegister iconRegister) {
		icons[I_BACK] = iconRegister
				.registerIcon("nuclearcontrol:remoteThermo/back");
		icons[I_FACE] = iconRegister
				.registerIcon("nuclearcontrol:remoteThermo/face");
		icons[I_SIDE] = iconRegister
				.registerIcon("nuclearcontrol:remoteThermo/side");
		icons[I_SCALE] = iconRegister
				.registerIcon("nuclearcontrol:remoteThermo/scale");
	}
