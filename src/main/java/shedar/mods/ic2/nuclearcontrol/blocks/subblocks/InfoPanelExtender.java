...
public class InfoPanelExtender extends InfoPanel
{
	...
	{
		{I_EXTENDER_BACK, I_COLOR_DEFAULT, I_EXTENDER_SIDE, I_EXTENDER_SIDE, I_EXTENDER_SIDE, I_EXTENDER_SIDE},
		{I_COLOR_DEFAULT, I_EXTENDER_BACK, I_EXTENDER_SIDE, I_EXTENDER_SIDE, I_EXTENDER_SIDE, I_EXTENDER_SIDE},
		{I_EXTENDER_SIDE, I_EXTENDER_SIDE, I_EXTENDER_BACK, I_COLOR_DEFAULT, I_EXTENDER_SIDE, I_EXTENDER_SIDE},
		{I_EXTENDER_SIDE, I_EXTENDER_SIDE, I_COLOR_DEFAULT, I_EXTENDER_BACK, I_EXTENDER_SIDE, I_EXTENDER_SIDE},
		{I_EXTENDER_SIDE, I_EXTENDER_SIDE, I_EXTENDER_SIDE, I_EXTENDER_SIDE, I_EXTENDER_BACK, I_COLOR_DEFAULT},
		{I_EXTENDER_SIDE, I_EXTENDER_SIDE, I_EXTENDER_SIDE, I_EXTENDER_SIDE, I_COLOR_DEFAULT, I_EXTENDER_BACK}
	};
