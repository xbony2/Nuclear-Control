	...
	public void registerTileEntities() {
		...
		ClientRegistry
				.registerTileEntity(
						...
						"IC2Thermo", renderThermalMonitor);
		GameRegistry
				.registerTileEntity(
