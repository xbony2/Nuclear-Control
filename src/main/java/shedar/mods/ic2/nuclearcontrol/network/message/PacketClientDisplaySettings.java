...
public class PacketClientDisplaySettings implements IMessage,
		IMessageHandler<PacketClientDisplaySettings, IMessage> {
	private int x;
	private int y;
	private int z;
	private byte slot;
	...
	public PacketClientDisplaySettings(int x, int y, int z, byte slot,
			int settings) {
		this.x = x;
		this.y = y;
		this.z = z;
