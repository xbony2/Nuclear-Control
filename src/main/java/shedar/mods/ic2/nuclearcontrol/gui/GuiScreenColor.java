...
public class GuiScreenColor extends GuiScreen{
    ...
    public void drawScreen(int par1, int par2, float par3){
        ...
        fontRendererObj.drawString(LanguageHelper.translate("msg.nc.ScreenColor"), guiLeft + 8, guiTop + 20, 0x404040);
        fontRendererObj.drawString(LanguageHelper.translate("msg.nc.TextColor"), guiLeft + 8, guiTop + 52, 0x404040);
