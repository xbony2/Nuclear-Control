...
@Mod(modid = "IC2NuclearControl", name = "Nuclear Control 2", version = "2.0.5b-Unicorn", dependencies = "required-after:IC2", guiFactory = "shedar.mods.ic2.nuclearcontrol.gui.GuiFactory")
