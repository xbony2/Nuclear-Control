	...
	public static void addOldRecipes() {
		...
		Recipes.advRecipes.addRecipe(new ItemStack(
				...
				new Object[] { "RYG", "WCM", "IAB", 'R', "dyeRed", 'Y',
						...
						IC2Items.getItem("insulatedCopperCableItem"), 'M',
						"dyeMagenta", 'I', "dyeBlack", 'A', "dyeCyan", 'B',
						"dyeBlue" });

		/*
		 * if(isHttpSensorAvailable){ Recipes.advRecipes.addRecipe(new
		 * ItemStack(IC2NuclearControl.itemUpgrade, 1, ItemUpgrade.DAMAGE_WEB),
		 * new Object[]{ "CFC","CAC","CFC", 'C', new
		 * ItemStack(IC2NuclearControl.itemUpgrade, 1,
		 * ItemUpgrade.DAMAGE_RANGE), 'A', IC2Items.getItem("advancedCircuit"),
		...
		Recipes.advRecipes.addRecipe(new ItemStack(
				...
				ItemKitMultipleSensor.TYPE_COUNTER), new Object[] { "  F",
				" C ", "P  ", 'P', Items.paper, 'C', "circuitBasic", 'F',
				IC2Items.getItem("frequencyTransmitter") });

		Recipes.advRecipes.addRecipe(new ItemStack(
				IC2NuclearControl.itemMultipleSensorKit, 1,
				ItemKitMultipleSensor.TYPE_LIQUID), new Object[] { "  F",
				" C ", "P  ", 'P', Items.paper, 'C', Items.bucket, 'F',
				IC2Items.getItem("frequencyTransmitter") });
